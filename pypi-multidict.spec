...
Source0  : https://files.pythonhosted.org/packages/82/4a/7874ca44a1c9b23796c767dd94159f6c17e31c0e7d090552a1c623247d82/multidict-6.2.0.tar.gz
...
%prep
%setup -q -n multidict-6.2.0
cd %{_builddir}/multidict-6.2.0
pushd ..
cp -a multidict-6.2.0 buildavx2
popd
pushd ..
cp -a multidict-6.2.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742437339
