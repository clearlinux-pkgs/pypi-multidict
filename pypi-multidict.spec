...
Source0  : https://files.pythonhosted.org/packages/f9/79/722ca999a3a09a63b35aac12ec27dfa8e5bb3a38b0f857f7a1a209a88836/multidict-6.0.5.tar.gz
...
%prep
%setup -q -n multidict-6.0.5
cd %{_builddir}/multidict-6.0.5
pushd ..
cp -a multidict-6.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706892754
