...
Source0  : https://files.pythonhosted.org/packages/fa/2d/6e0d6771cadd5ad14d13193cc8326dc0b341cc1659c306cbfce7a5058fff/multidict-6.3.2.tar.gz
...
%prep
%setup -q -n multidict-6.3.2
cd %{_builddir}/multidict-6.3.2
pushd ..
cp -a multidict-6.3.2 buildavx2
popd
pushd ..
cp -a multidict-6.3.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743781963
