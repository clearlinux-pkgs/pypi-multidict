...
Source0  : https://files.pythonhosted.org/packages/91/2f/a3470242707058fe856fe59241eee5635d79087100b7042a867368863a27/multidict-6.4.4.tar.gz
...
%prep
%setup -q -n multidict-6.4.4
cd %{_builddir}/multidict-6.4.4
pushd ..
cp -a multidict-6.4.4 buildavx2
popd
pushd ..
cp -a multidict-6.4.4 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747674569
