...
Source0  : https://files.pythonhosted.org/packages/b5/5b/1dd3b9cf73c474ea1d0f0b1f8b7b712b0f13817493fd93101256ec856b59/multidict-6.0.3.tar.gz
...
%prep
%setup -q -n multidict-6.0.3
cd %{_builddir}/multidict-6.0.3
pushd ..
cp -a multidict-6.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670497967
